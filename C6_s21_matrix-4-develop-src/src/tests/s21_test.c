 ...
 * Edit the original source file "tests/s21_unit_test.check" instead.
 */
...
START_TEST(test_s21_determinant_11) {
  ...
  ck_assert_ldouble_eq_tol(number, 13608, EPSILON);
  s21_remove_matrix(&a);
}
END_TEST
...
START_TEST(test_s21_determinant_13) {
  ...
  ck_assert_ldouble_eq_tol(res, 0, EPSILON);
  ck_assert_int_eq(code, OK);
...
START_TEST(test_s21_determinant_14) {
  ...
  double res = 0;
  int code = s21_determinant(&m, &res);
  ck_assert_double_eq_tol(res, 0, EPSILON);
  ck_assert_int_eq(code, OK);
...
START_TEST(test_s21_determinant_15) {
  ...
  double res = 0;
  int code = s21_determinant(&m, &res);
  ck_assert_double_eq_tol(res, 2480, EPSILON);
  ck_assert_int_eq(code, OK);
...
START_TEST(test_s21_determinant_17) {
  ...
  double res = 0;
  int code = s21_determinant(&m, &res);
  ck_assert_double_eq_tol(res, 7, EPSILON);
  ck_assert_int_eq(code, OK);
...
START_TEST(test_s21_determinant_18) {
  matrix_t A;
  double B = 1.25, R = 1.25;
  s21_create_matrix(1, 1, &A);
...
START_TEST(test_s21_determinant_19) {
  matrix_t A;
  double B, R = -69;
  s21_create_matrix(3, 3, &A);
...
START_TEST(test_s21_determinant_20) {
  matrix_t A;
  double B, R = -2;
  s21_create_matrix(3, 3, &A);
...
START_TEST(test_s21_determinant_21) {
  matrix_t A;
  double B, R = -2;
  s21_create_matrix(3, 3, &A);
...
START_TEST(test_s21_determinant_22) {
  matrix_t A;
  double B, R = 25;
  s21_create_matrix(3, 3, &A);
...
START_TEST(test_s21_determinant_23) {
  matrix_t A;
  double B, R = 23;
  s21_create_matrix(3, 3, &A);
...
START_TEST(test_s21_determinant_24) {
  matrix_t A;
  double B, R = -8;
  s21_create_matrix(3, 3, &A);
...
START_TEST(test_s21_determinant_25) {
  matrix_t A;
  double B, R = 18;
  s21_create_matrix(4, 4, &A);
...
START_TEST(test_s21_determinant_26) {
  matrix_t A;
  double B, R = -69.0 / 4.0;
  s21_create_matrix(5, 5, &A);
...
START_TEST(test_s21_determinant_27) {
  matrix_t A;
  double B;
  s21_create_matrix(4, 5, &A);
  int res = s21_determinant(&A, &B);
...
START_TEST(test_s21_determinant_28) {
  matrix_t a;
  double number;
  s21_create_matrix(4, 4, &a);
  a.matrix[0][0] = 1;
...
START_TEST(test_s21_determinant_29) {
  matrix_t *B = NULL;
  double re = 0;
  int res = s21_determinant(B, &re);
  ck_assert_int_eq(res, INCORRECT_MATRIX);
...
START_TEST(test_s21_determinant_30) {
  const int size = 5;
  matrix_t m = {0};
  s21_create_matrix(size, size, &m);
...
START_TEST(test_s21_determinant_31) {
  const int size = 4;
  matrix_t m = {0};
  s21_create_matrix(size, size, &m);
...
START_TEST(test_s21_determinant_32) {
  const int size = 5;
  matrix_t m = {0};
  s21_create_matrix(size, size, &m);
  m.matrix[0][1] = 6;
...
START_TEST(test_s21_determinant_33) {
  const int size = 3;
  matrix_t m = {0};
  s21_create_matrix(size, size, &m);
  m.matrix[0][0] = 2;
...
START_TEST(test_s21_determinant_34) {
  const int size = 2;
  matrix_t m = {0};
  s21_create_matrix(size, size, &m);
  m.matrix[0][0] = -5;
...
START_TEST(test_s21_sum_matrix_11) {
...
START_TEST(test_s21_sum_matrix_12) {
  matrix_t A, B, R, R2;
  s21_create_matrix(1, 1, &A);
  s21_create_matrix(1, 1, &B);
...
START_TEST(test_s21_sum_matrix_13) {
  matrix_t A, B, R, R2;
  s21_create_matrix(3, 3, &A);
  s21_create_matrix(3, 3, &B);
...
START_TEST(test_s21_sum_matrix_14) {
  matrix_t A, B, R;
  s21_create_matrix(1, 1, &A);
...
START_TEST(test_s21_sum_matrix_15) {
  matrix_t *A = NULL;
  matrix_t *B = NULL;
  matrix_t *R = NULL;
  int res = s21_sum_matrix(A, B, R);
...
START_TEST(test_s21_sub_matrix_11) {
  matrix_t A, B, R, R2;
  s21_create_matrix(1, 1, &A);
  s21_create_matrix(1, 1, &B);
  s21_create_matrix(1, 1, &R2);
...
START_TEST(test_s21_sub_matrix_12) {
  matrix_t A, B, R, R2;
  s21_create_matrix(3, 3, &A);
  s21_create_matrix(3, 3, &B);
  s21_create_matrix(3, 3, &R2);
...
START_TEST(test_s21_sub_matrix_13) {
  matrix_t A, B, R;
  s21_create_matrix(1, 1, &A);
  s21_create_matrix(2, 1, &B);
...
START_TEST(test_s21_sub_matrix_14) {
  matrix_t *A = NULL;
  matrix_t *B = NULL;
  matrix_t *R = NULL;
  int res = s21_sub_matrix(A, B, R);
...
START_TEST(test_s21_create_matrix_12) {
  ...
  int columns = 10;
  matrix_t matrix = {0};
  int error = s21_create_matrix(rows, columns, &matrix);
  ...
  if (error == OK) s21_remove_matrix(&matrix);
}
END_TEST
...
START_TEST(test_s21_create_matrix_15) {
  int rows = -10;
  int columns = 10;
  matrix_t matrix = {0};
  int error = s21_create_matrix(rows, columns, &matrix);
...
int main(void) {
  ...
  tcase_add_test(tc1_1, test_s21_calc_complements_10);
  ...
  tcase_add_test(tc1_1, test_s21_determinant_11);
  tcase_add_test(tc1_1, test_s21_determinant_12);
  tcase_add_test(tc1_1, test_s21_determinant_13);
  tcase_add_test(tc1_1, test_s21_determinant_14);
  tcase_add_test(tc1_1, test_s21_determinant_15);
  tcase_add_test(tc1_1, test_s21_determinant_16);
  tcase_add_test(tc1_1, test_s21_determinant_17);
  tcase_add_test(tc1_1, test_s21_determinant_18);
  tcase_add_test(tc1_1, test_s21_determinant_19);
  tcase_add_test(tc1_1, test_s21_determinant_20);
  tcase_add_test(tc1_1, test_s21_determinant_21);
  tcase_add_test(tc1_1, test_s21_determinant_22);
  tcase_add_test(tc1_1, test_s21_determinant_23);
  tcase_add_test(tc1_1, test_s21_determinant_24);
  tcase_add_test(tc1_1, test_s21_determinant_25);
  tcase_add_test(tc1_1, test_s21_determinant_26);
  tcase_add_test(tc1_1, test_s21_determinant_27);
  tcase_add_test(tc1_1, test_s21_determinant_28);
  tcase_add_test(tc1_1, test_s21_determinant_29);
  tcase_add_test(tc1_1, test_s21_determinant_30);
  tcase_add_test(tc1_1, test_s21_determinant_31);
  tcase_add_test(tc1_1, test_s21_determinant_32);
  tcase_add_test(tc1_1, test_s21_determinant_33);
  tcase_add_test(tc1_1, test_s21_determinant_34);
  ...
  tcase_add_test(tc1_1, test_s21_sum_matrix_11);
  tcase_add_test(tc1_1, test_s21_sum_matrix_12);
  tcase_add_test(tc1_1, test_s21_sum_matrix_13);
  tcase_add_test(tc1_1, test_s21_sum_matrix_14);
  tcase_add_test(tc1_1, test_s21_sum_matrix_15);
  ...
  tcase_add_test(tc1_1, test_s21_sub_matrix_11);
  tcase_add_test(tc1_1, test_s21_sub_matrix_12);
  tcase_add_test(tc1_1, test_s21_sub_matrix_13);
  tcase_add_test(tc1_1, test_s21_sub_matrix_14);
  ...
  tcase_add_test(tc1_1, test_s21_mult_number_10);
  ...
  tcase_add_test(tc1_1, test_s21_create_matrix_10);
  tcase_add_test(tc1_1, test_s21_create_matrix_11);
  tcase_add_test(tc1_1, test_s21_create_matrix_12);
  tcase_add_test(tc1_1, test_s21_create_matrix_13);
  tcase_add_test(tc1_1, test_s21_create_matrix_14);
  tcase_add_test(tc1_1, test_s21_create_matrix_15);
  ...
  tcase_add_test(tc1_1, test_s21_eq_matrix_11);
  tcase_add_test(tc1_1, test_s21_eq_matrix_12);
  tcase_add_test(tc1_1, test_s21_eq_matrix_13);
